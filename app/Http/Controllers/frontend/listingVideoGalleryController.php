...
class listingVideoGalleryController extends Controller
{
    ...
    public function index()
    {
        ...
        $noOfVideo=new maximumVideos();
        $noOfVideo=$noOfVideo->passes();
        return view('frontend.dashboard.listing.video-gallery.index', compact('videoGallery', 'videoGalleryList','noOfVideo'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.listing-video-gallery.index', ['list_id' => $request->list_id]);
    }
