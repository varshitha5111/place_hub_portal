...
class agentListingScheduleDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                $edit = '<div class="row"><div class="col-1"><a href="' . route('user.listing.schedule.edit', [$query->list_id, $query->id]) . '" class="btn btn-primary btn-sm"><i class="fas fa-pen"></i></a></div>';
     ...
     *
     * @param \App\Models\agentListingSchedule $model
