            ...
            <div class="col-lg-9">
                <div class="dashboard_content">
                    <div class="my_listing">
                        ...
                        <br><br>
                        <div class="card-body">
                            <form method="post" action="<?php echo e(route('user.agent-listing.update',$listing->slug)); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-md-12 my-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <div class="btn btn-warning my-1">
                                                ...
                                                <input class="form-check-input mx-1" id=<?php echo 'ipcheck' . $i; ?> onchange="checkAmen(<?php echo $i ?>,<?php echo $maxAmentity ?>)" type="checkbox" id=<?php echo 'inlineCheckbox' . $i; ?> name="amentity[]" value="<?php echo e($amentity->id); ?>" <?php echo ($amentity_list->contains('amentity_id', $amentity->id)) ? 'checked' : '' ?>>
                                                <?php else: ?>
                                                <input class="form-check-input mx-1" id=<?php echo 'ipcheck' . $i; ?> type="checkbox" id=<?php echo 'inlineCheckbox' . $i; ?> name="amentity[]" value="<?php echo e($amentity->id); ?>" <?php echo ($amentity_list->contains('amentity_id', $amentity->id)) ? 'checked' : '' ?>>
                                                <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_projects\listing\resources\views/frontend/dashboard/listing/edit.blade.php ENDPATH**/ ?>