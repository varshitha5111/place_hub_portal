<div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
    <form method="post" action="<?php echo e(route('admin.setting.create')); ?>" enctype="multipart/form-data">
        ...
        <div class="col-md-6 my-3">
            ...
            <input type="text" class="form-control" id="inputEmail4" name="icon" value="<?php echo e($settings['icon']); ?>">
...
</div><?php /**PATH C:\laravel_projects\listing\resources\views/admin/setting/general-setting.blade.php ENDPATH**/ ?>