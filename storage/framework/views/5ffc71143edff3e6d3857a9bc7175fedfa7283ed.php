    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo e(route('admin.package.update',$packs->id)); ?>" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 my-3">
                                ...
                                <input type="text" class="form-control" id="inputEmail4" name="name" value="<?php echo e($packs->name); ?>">
                                <?php if($errors->has('no_of_pack')): ?>
                                <p class="text-danger text-small">$errors->get('name')</p>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6 my-3">
                                <label for="inputEmail4" class="form-label">Number Of Days</label>
                                <input type="text" class="form-control" id="inputEmail4" name="no_of_days" value="<?php echo e($packs->number_of_days); ?>">
                            ...
                            <div class="col-md-6 my-3">
                                ...
                                <input type="text" class="form-control" id="inputEmail4" name="no_of_list" value="<?php echo e($packs->no_of_listing); ?>">
                                <?php if($errors->has('no_of_list')): ?>
                                <p class="text-danger text-small">$errors->get('name')</p>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6 my-3">
                                <label for="inputEmail4" class="form-label">Number of photos</label>
                                <input type="text" class="form-control" id="inputEmail4" name="no_of_photo" value="<?php echo e($packs->no_of_photos); ?>">
                                <?php if($errors->has('no_of_photo')): ?>
                                <p class="text-danger text-small">$errors->get('name')</p>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6 my-3">
                                <label for="inputEmail4" class="form-label">Number Of amenity</label>
                                <input type="text" class="form-control" id="inputEmail4" name="no_of_amenity" value="<?php echo e($packs->no_of_amentities); ?>">
                                <?php if($errors->has('no_of_amenity')): ?>
                                <p class="text-danger text-small">$errors->get('name')</p>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6 my-3">
                                <label for="inputEmail4" class="form-label">Name Of Videos</label>
                                <input type="text" class="form-control" id="inputEmail4" name="no_of_video" value="<?php echo e($packs->no_of_video); ?>">
                                <?php if($errors->has('no_of_video')): ?>
                                <p class="text-danger text-small">$errors->get('name')</p>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6 my-3">
                                ...
                                <div id="price">
                                    <input type="text" class="form-control" id="inputEmail4" name="price" value="<?php echo e($packs->price); ?>" <?php echo $packs->type==='free'?'disabled':''; ?>>
                                </div>
                            ...
                            <div class="col-md-6 my-3">
                                ...
                                <input type="text" class="form-control" id="inputEmail4" name="no_featured_list" value="<?php echo e($packs->no_of_featured_listing); ?>">
                                <?php if($errors->has('no_featured_list')): ?>
                                <p class="text-danger text-small">$errors->get('name')</p>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6 my-3">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_projects\listing\resources\views/admin/packages/edit.blade.php ENDPATH**/ ?>