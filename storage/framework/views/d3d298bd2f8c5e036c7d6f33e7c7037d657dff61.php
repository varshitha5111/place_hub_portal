    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo e(route('admin.listing-image-gallery.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr class="my-2">
                        ...
                        <td><img src="<?php echo e(asset($img->image)); ?>" width="80"></td>
                        <td>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel_projects\listing\resources\views/admin/listing/image-gallery/index.blade.php ENDPATH**/ ?>