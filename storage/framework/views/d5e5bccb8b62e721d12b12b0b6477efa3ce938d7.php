         ...
         <div class="row">
                 ...
                 <div class="row">
                     <div class="col">
                         <div class="wsus__topbar_right">
                             <a href="<?php echo e(route('user.login')); ?>"><i class="fas fa-user"></i> Login</a>
                             <a href="<?php echo e(route('user.register')); ?>"><i class="fas fa-user"></i> Register</a>
                         </div>
                         <div class="wsus__topbar_right">
                         </div>
                     </div>
             ...
             <div class="col-xl-6 col-md-6">
                 <div class="row">
                     <div class="col">
                         <div class="wsus__topbar_right">
                             <a href="<?php echo e(route('user.dashboard')); ?>"><i class="fas fa-user"></i></a>
                         </div>
                         <div class="wsus__topbar_right">
                         </div>
                     </div>
     ...
     <div class="container">
         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent">
             ...
             <ul class="navbar-nav m-auto">
                 <li class="nav-item">
                     <a class="nav-link active" aria-current="page" href="<?php echo e(route('frontend.index')); ?>">Home</a>
                 </li>
                 <li class="nav-item">
                 ...
                 <li class="nav-item">
                     ...
                     <ul class="menu_droapdown">
                         ...
                         <li><a href="<?php echo e(route('user.listing.packages')); ?>">Packages</a></li>
 ...
 <!--==========================
        MENU PART END
    ===========================--><?php /**PATH C:\laravel_projects\listing\resources\views/frontend/layout/navbar.blade.php ENDPATH**/ ?>