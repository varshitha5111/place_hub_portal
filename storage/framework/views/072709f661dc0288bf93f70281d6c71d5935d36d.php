                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="<?php echo e(asset('admin/assets/img/avatar/logo.jpg')); ?>" alt="logo" width="100" class="shadow-light rounded-circle">
                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-block">
                                            ...
                                            <div class="float-right">
                                                ...
                                                <a class="underline text-small text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('password.request')); ?>">
...
</html><?php /**PATH C:\laravel_projects\listing\resources\views/auth/login.blade.php ENDPATH**/ ?>