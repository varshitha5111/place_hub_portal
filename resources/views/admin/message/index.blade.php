                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled list-unstyled-border">
                            ...
                            <li class="media" style="cursor: pointer;" id="senderProfile" data-current-user-id="{{auth()->user()->id}}" data-sender-profile-id="{{$sender->senderProfile->id}}" data-list-id="{{$sender->listings->id}}">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="mt-0 mb-1 font-weight-bold">{{$sender->senderProfile->name}} ( {{$sender->listings->title}} )</div>
...
<script>
    function updateConversation(sender) {
        ...
        window.location.href = "{{ route('admin.message.conversation', ['sender_id' => ':senderProfileId', 'list_id' => ':listingId']) }}"
...
<script>
    ...
    $(document).on('click', '#senderProfile', function(e) {
        ...
        var finalurl = "{{ route('admin.message.conversation', ['sender_id' => ':sender_id', 'list_id' => ':list_id']) }}"
...
<script>
    $(document).on('submit', '#chat-form', function(e) {
        ...
        msg = $('#msg').val()
        finalurl = '{{route("admin.message.send",["reciever_id"=>":reciever_id","sender_id"=>":sender_id","list_id"=>":list_id","msg"=>":msg"])}}'
