                    ...
                    <form method="post" action="{{route('admin.hero.update')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <div id="image-preview" class="image-preview">
                                        ...
                                        <input type="hidden" name="oldImg" value="{{$hero->banner}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 my-3">
                                <label for="inputEmail4" class="form-label">Title</label>
                                <input type="text" class="form-control" id="inputEmail4" name="title" value="{{$hero->title}}">
                                @if($errors->has('name'))
                            ...
                            <div class="col-md-12 my-3">
                                ...
                                <input type="text" class="form-control" id="inputPassword4" name="sub" value="{{$hero->sub_title}}">
                                @if($errors->has('email'))
