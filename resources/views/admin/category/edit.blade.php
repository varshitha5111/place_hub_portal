    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin.category.edit.submit',$category->slug)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <div id="image-preview" class="image-preview">
                                        ...
                                        <input type="hidden" name="oldImg" value="{{$category->icon_image}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <div id="image-preview-2" class="image-preview">
                                        ...
                                        <input type="hidden" name="oldImg" value="{{$category->bg_image}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 my-3">
                                <label for="inputEmail4" class="form-label">Name</label>
                                <input type="text" class="form-control" id="inputEmail4" name="name" value="{{$category->name}}">
                                @if($errors->has('name'))
                            ...
                            <div class="col-md-12 my-3">
                                ...
                                <select class="form-control" aria-label="Default select example" name="show_at_home">
                                    <option value="1" {{ $category->show_at_home===1?'selected':''}}>Yes</option>
                                    <option value="0" {{ $category->show_at_home===0?'selected':''}}>No</option>
                                </select>
                            ...
                            <div class="col-md-12 my-3">
                                ...
                                <select class="form-control " aria-label="Default select example" name="status">
                                    ...
                                    <option value="0" {{$category->status===1?'selected':''}}>Inactive</option>
                                </select>
